...
const OptionTable = () => {
    ...
    return (
        <div className="Option">         
            <div className="optionStyle">
                ...
                <div className="options1">
                    {themeFormData.map((Option) => (
                        <label key={Option.id} id="OptionLabel">
                            <input type="checkbox" value={Option.name} id="theme" className="optionBox1" onChange={(e) => clickHandler(e)} />{Option.name}
                        </label>
                    ))}
                </div>
                ...
                <div className="options2" >
                    {tasteFormData.map((Option) => (
                        <label key={Option.id} id="OptionLabel">
                            <input type="checkbox" value={Option.name} id="taste" className="optionBox2" onChange={(e) => clickHandler(e)} />{Option.name}
                        </label>
                    ))}
                </div>
                </div>
                ...
                <div className="options3" id="optionIngre">
                    {ingreFormData.map((Option) => (
                        <label key={Option.id} id="OptionLabel">
                            <input type="checkbox" value={Option.name} id="ingre" className="optionBox3" onChange={(e) => clickHandler(e)} />{Option.name}
                        </label>
                    ))}
                </div>
                ...
                <div className="options4" id="optionSitua">
                    {situaFormData.map((Option) => (
                        <label key={Option.id} id="OptionLabel">
                            <input type="checkbox" value={Option.name} id="situa" className="optionBox4" onChange={(e) => clickHandler(e)} />{Option.name}
                        </label>
                    ))}
                </div>
                </div>
            ...
            <Link to="/Recipe"><input type="submit" id="Find" value="찾기" onClick={goBackend}/></Link>
        </div>
    );
};
